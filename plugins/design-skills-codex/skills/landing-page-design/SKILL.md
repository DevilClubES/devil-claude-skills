...
```text
$landing-page-design audit <page>
$landing-page-design outline <brief>
$landing-page-design build <brief or approved outline>
$landing-page-design refine <page and goal>
```
...
Inspect `DESIGN.md`, tokens, primitives, and existing marketing surfaces. Use `$design-studio` when the work needs broader direction exploration or a new cross-product visual system.
